...
# sostituzione di batchNorm2d con GroupNorm 
# --- NUOVA FUNZIONE HELPER ---#######################################
def get_norm_layer(num_channels):
    # Usa 32 gruppi o il numero di canali, se inferiore (InstanceNorm)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn1 = get_norm_layer(planes) #### NUOVO 

        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)

        #self.bn2 = nn.BatchNorm2d(planes)
        self.bn2 = get_norm_layer(planes) ### NUOVO 

        self.conv3 = nn.Conv2d(planes, self.expansion*planes, kernel_size=1, bias=False)

        #self.bn3 = nn.BatchNorm2d(self.expansion*planes)
        self.bn3 = get_norm_layer(self.expansion*planes) ### NUOVO 
        ...
        if stride != 1 or in_planes != self.expansion*planes:
            self.shortcut = nn.Sequential(
                ...
                get_norm_layer(self.expansion*planes) ### NUOVO
            )
...
class FPN(nn.Module):
    def __init__(self, backbone_name = 'resnet101', resnet_num_blocks=[2,4,23,3],n_channels=4,n_classes=1,params=[3,1000,1000]):
        ...
        if backbone_name == 'resnet101': 
            ...
            self.bn1 = get_norm_layer(64) # NUOVO 
        ...
        # common part: definition of FPN decoder 
        ...
        self.gn12 = nn.GroupNorm(32, 256) ### NUOVO 

        self.gn21 = nn.GroupNorm(128, 128) 

        #self.gn22 = nn.GroupNorm(256, 256)
        self.gn22 = nn.GroupNorm(32, 256) ### NUOVO 
