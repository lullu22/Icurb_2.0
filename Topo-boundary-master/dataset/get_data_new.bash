mkdir -p ./cropped_tiff_1
# mkdir -p ./temp_raw_tiff_1
...
#rm -rf ./Manhattan.zip
# mv ./Manhattan/*.jp2 ./temp_raw_tiff_1
# rm -rf ./Manhattan
...
# rm -rf ./Richmond.zip
# mv ./Richmond/*.jp2 ./temp_raw_tiff_1
# rm -rf ./Richmond
